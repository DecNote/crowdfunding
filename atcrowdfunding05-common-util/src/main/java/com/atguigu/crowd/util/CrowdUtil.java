...
//        InputStream inputStream = new FileInputStream("C:\\Users\\Dec\\Desktop");
...
//        ResultEntity<String> resultEntity = uploadFileToOss(endpoint, accessKeyId, accessKeySecret, inputStream, bucketName, bucketDomain, originalName);
