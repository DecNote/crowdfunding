...
public class CrowdAccessFilter extends ZuulFilter {
    ...
    public boolean shouldFilter() {
        ...
        // 5.判断当前请求是否为静态资源（工具方法返回true：说明当前请求是静态资源请求）
        containsResult = AccessPassResources.judgeCurrentServletPathWetherStaticResource(servletPath);
        if (containsResult) {
            return false;
        }
