...
public class ProjectConsumerHandler {
     ...
     * 上传回报信息
     *
     * @param returnVO  表单传来的回报信息
     * @param session request域的session
     */
    @ResponseBody
    ...
    /**
     * 上传回报信息的图片，JavaScript代码：formData.append("returnPicture", file);
     *
     * @param returnPicture 接收用户上传的文件（回报信息的图片）
     */
    @ResponseBody
    ...
    public String saveProjectBasicInfo(ProjectVO projectVO, MultipartFile headerPicture, List<MultipartFile> detailPictureList, HttpSession session, ModelMap modelMap
    ) throws IOException {
